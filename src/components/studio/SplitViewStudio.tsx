...
import { User, Shirt, Palette, ArrowUpCircle, Image as ImageIcon, Maximize2, Camera, Video, FileImage, Download, ThumbsUp, ThumbsDown } from 'lucide-react';
...
export default function SplitViewStudio({ selectedWorkflow, workflowName, onSelectWorkflow }: SplitViewStudioProps) {
  ...
  const handleGenerate = async (data: Record<string, unknown>) => {
    ...
    setTimeout(() => {
      ...
      const newResult: GenerationResult = {
        ...
        imageUrls: mockImages.slice(0, 2),
        timestamp: new Date(),
      };
  ...
  return (
    <div className="h-screen flex bg-white dark:bg-black">
      ...
      <div className="w-80 lg:w-96 border-r border-gray-200 dark:border-gray-800 flex flex-col h-screen overflow-hidden">
        {/* Header */}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-900 group-hover:bg-brand/10 flex items-center justify-center">
